...
export function Plugins({ onSend }: { onSend: () => void }) {
  ...
  return (
    <div className="relative">
      ...
      <ToolbarPlugin>
        {({ blockType }) => (
          <div className="vertical-align-middle sticky bottom-0 z-10 flex items-center gap-2 overflow-auto border-t p-1">
            ...
            <Button
              onClick={onSend}
              className="bg-blue-1 rounded-[8px] ml-auto hover:bg-blue-1"
              size={'icon-sm'}
            >
