    ...
    <Link href={item.path} onClick={() => setCurrentMenu(item.index)}>
      <div
        className={cn(
          ...
          menu.activeMenuKey === item.index && 'bg-[#E5F1FF] py-8 group-hover:py-4 text-[#131315]',
        )}
      >
        {item.icon && (
          <item.icon
  ...
  return (
    <div className={styles['menu-wrapper'] + ' group'}>
      <div className={'flex flex-col gap-4'}>
        ...
        <button className="color-main shadow-btn py-16 group-hover:py-3 px-4 rounded-[64px] flex items-center flex-row">
